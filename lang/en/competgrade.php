...
/**
 * Strings for component 'competgrade', language 'en'
 *
...
$string['competgrade:addinstance'] = 'Add a new Compete grade instance';
$string['competgrade:view'] = 'View a Compete grade instance';
$string['modulename'] = 'Compet Grade';
$string['modulename_help'] = 'The Compet Eval Grading interface.';
$string['modulename_link'] = 'mod/competgrade/view';
$string['modulenameplural'] = 'Compet Grades';
$string['privacy:metadata'] = 'The Compet grade plugin does not store any personal data.';
$string['pluginname'] = 'Compet grade';
$string['pluginadministration'] = 'Compet grade administration';
