...
class grade extends \data_object {
    ...
    /**
    * @param $params
    * @return object marker grades
    */
    public static function fetch($params) {
        return self::fetch_helper('competgrade_grade', __CLASS__, $params);
    }
    ...
    public static function fetch_all($params, $sort = false) {
        $ret = self::fetch_all_helper('competgrade_grade', __CLASS__, $params);
        if (!$ret) {
            $ret = [];
        }
        if (count($ret)) {
